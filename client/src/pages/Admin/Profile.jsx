...
function Profile() {
 ...
 <div className='skeleton flex items-center justify-between px-6 py-4 border-b border-gray-100'>
 <h3 className='font-bold text-[#3A3A3A]'>Personal Information</h3>
 <button onClick={() => setIsEditingPersonal(!isEditingPersonal)} className='skeleton p-1.5 rounded-lg hover: cursor-pointer transition-colors'><EditIcon className='w-4 h-4 text-gray-500' /></button>
 </div>
 ...
 {isEditingPersonal && (
 <div className='skeleton px-6 py-4 border-t border-gray-100 flex justify-end gap-2'>
 ...
 <button onClick={() => setIsEditingAdmin(!isEditingAdmin)} className='skeleton p-1.5 rounded-lg hover: cursor-pointer transition-colors'><EditIcon className='w-4 h-4 text-gray-500' /></button>
 </div>
 <div className='divide-y divide-gray-50 px-6'>
 <div className='flex justify-between items-center py-3.5'>
 ...
 <button onClick={() => setIsEditingPassword(!isEditingPassword)} className='skeleton p-1.5 rounded-lg hover: cursor-pointer transition-colors'><EditIcon className='w-4 h-4 text-gray-500' /></button>
 </div>
 {isEditingPassword ? (
 ...
 <div className='bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden'>
 <div className='skeleton px-6 py-4 border-b border-gray-100 flex items-center gap-3'>
 ...
 <div className='skeleton px-6 py-4 border-t border-gray-100 flex justify-end'>
