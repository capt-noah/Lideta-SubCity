...
function Vacancy() {
 ...
 if (loading) return (
    <div className='p-6 space-y-6'>
      ...
      <div className='flex gap-1 border-b border-gray-200'>
        <div className='skeleton h-10 w-24 rounded-t-lg' />
      ...
      <div className='bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm'>
        <div className='bg-gray-50 border-b border-gray-100 px-5 py-3.5 grid grid-cols-[2fr_1fr_1fr_1fr_1fr_80px] gap-4'>
          {[1,2,3,4,5,6].map(i => <div key={i} className='skeleton h-3 rounded w-14' />)}
        </div>
        {[1,2,3,4,5,6].map(i => (
          <div key={i} className='px-5 py-4 border-b border-gray-50 grid grid-cols-[2fr_1fr_1fr_1fr_1fr_80px] gap-4 items-center'>
 ...
 <td className='px-4 py-3.5 hidden md:table-cell'><span className='skeleton px-2 py-0.5 text-gray-600 rounded-full text-xs'>{v.type}</span></td>
