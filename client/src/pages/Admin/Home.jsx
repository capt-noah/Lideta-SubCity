...
function Home() {
 ...
 {/* Greeting Section */}
 <section className='bg-[#3A3A3A] rounded-3xl text-white px-8 py-8 flex justify-between items-center shadow-xl animate-fade-in-up'>
 <div className='space-y-2'>
 ...
 {/* Vacancies Stat */}
 <div className='bg-white border-2 border-[#E0E0E0] rounded-2xl p-4 flex flex-col justify-between hover:shadow-md transition-shadow animate-fade-in-up delay-100'>
 <div className='flex justify-between items-start'>
 ...
 {/* Applicants Stat */}
 <div className='bg-white border-2 border-[#E0E0E0] rounded-2xl p-4 flex flex-col justify-between hover:shadow-md transition-shadow animate-fade-in-up delay-200'>
 <div className='flex justify-between items-start'>
 ...
 {/* Events Stat */}
 <div className='bg-white border-2 border-[#E00E0E0] rounded-2xl p-4 flex flex-col justify-between hover:shadow-md transition-shadow animate-fade-in-up delay-300'>
 <div className='flex justify-between items-start'>
 ...
 {/* News Stat */}
 <div className='bg-white border-2 border-[#E0E0E0] rounded-2xl p-4 flex flex-col justify-between hover:shadow-md transition-shadow animate-fade-in-up delay-400'>
 <div className='flex justify-between items-start'>
 ...
 <div className='h-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pb-2 animate-fade-in-up delay-400'>
 ...
 <div className='skeleton h-full flex items-center justify-center text-gray-400 italic border-2 border-dashed'>
 No News
 </div>
 )}
 </div>
 ...
 <div className=' px-2' >
 <div className='w-full h-170 bg-gray-50 rounded-xl flex flex-col py-6 px-4 space-y-6 overflow-hidden' >
 <div className='flex justify-between items-center px-1'>
 ...
 className='skeleton w-8 h-8 rounded-full flex items-center justify-center text-gray-400 hover:bg-green-100 hover:text-green-600 transition-colors shrink-0'
 >
